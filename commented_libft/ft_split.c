...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/09 11:19:18 by srossatt          #+#    #+#             */
/*   Updated: 2023/02/11 14:31:58 by srossatt         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * REMINDER: ft_substr creates a substring of 's' starting from the value of
 * 'start' with a maximum length of 'len'.
*/
...
/**                               FT_MAIN
 * Prints the 'tab' (string of strings) created by the function using a 
 * variable called 'tab' that contains the call of the function with the 
 * parameters selected to test it.
*/
int	main(void)
{
	char	**tab;
